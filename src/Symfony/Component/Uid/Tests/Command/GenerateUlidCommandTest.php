...
final class GenerateUlidCommandTest extends TestCase
{
    ...
    public function testDefaults()
    {
        ...
        $this->assertEquals(\DateTimeImmutable::createFromFormat('U.v', $time), $ulid->getDateTime());
    }
    ...
    public function testTimestampBeforeUnixEpoch()
    {
        ...
        $this->assertSame(2, $commandTester->execute(['--time' => '@-42']));
        $this->assertStringContainsString('Invalid timestamp "@-42".', $commandTester->getDisplay());
    }
    ...
    public function testInvalidFormat()
    {
        ...
        $this->assertSame(3, $commandTester->execute(['--format' => 'foo']));
