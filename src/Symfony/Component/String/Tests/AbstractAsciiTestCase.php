...
abstract class AbstractAsciiTestCase extends TestCase
{
     ...
     */
    public function testSingularize(string $plural, $expected)
    {
        $string = static::createFromString($plural);
        ...
        $expected = !\is_array($result) ? static::createFromString($expected) : array_map(static function (string $expected): AbstractString {
            return static::createFromString($expected);
        }, $expected);
     ...
     */
    public function testPluralize(string $singular, $expected)
    {
        $string = static::createFromString($singular);
        $result = $string->pluralize();
